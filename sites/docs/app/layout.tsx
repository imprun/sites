...
export const metadata: Metadata = {
	metadataBase: new URL("https://imprun.io"),
	title: "imprun Platform Documentation",
	description:
		"imprun Platform Documentation - Route, manage, and analyze your LLM requests across multiple providers with a unified API interface.",
	icons: {
