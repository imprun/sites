    ...
    <section className="relative overflow-hidden px-6 py-24 lg:px-8 lg:py-32 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute bottom-0 left-1/2 w-[700px] h-[700px] bg-gradient-to-br from-orange-400/20 to-red-400/20 rounded-full blur-3xl"
        />
      ...
      <div className="absolute inset-0 -z-5 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className="absolute top-32 left-10 w-20 h-20 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-2xl backdrop-blur-sm border border-white/20"
        />
        ...
        <motion.div
          ...
          className="absolute top-48 right-16 w-16 h-16 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-full backdrop-blur-sm border border-white/20"
        />
        ...
        <motion.div
          ...
          className="absolute bottom-32 right-1/4 w-24 h-24 bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-3xl backdrop-blur-sm border border-white/20"
        />
      </div>
      ...
      <div className="mx-auto max-w-7xl relative">
        <div className="flex flex-col items-center text-center gap-8">
          ...
          >
            코드만 작성하면 즉시 API 엔드포인트가 됩니다. 여러 AI 모델을 통합하고,
            개발한 API를 MCP Tool로 전환하여 AI 에이전트에게 제공할 수 있습니다.
          </motion.p>
          ...
          >
            ...
            >
              ...
              <div className="text-sm text-slate-600 mt-2">평균 응답 시간</div>
            </motion.div>
            <motion.div
              whileHover={{ scale: 1.05, y: -5 }}
            ...
            >
              ...
              <div className="text-sm text-slate-600 mt-2">Cold Start</div>
            </motion.div>
            <motion.div
              whileHover={{ scale: 1.05, y: -5 }}
            ...
            >
              ...
              <div className="text-sm text-slate-600 mt-2">비용 절감</div>
            </motion.div>
          </motion.div>
        </div>
      </div>
